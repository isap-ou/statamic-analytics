<!--
  ...
  -->
<script setup>
import {Button, CommandPaletteItem, Header, PublishContainer} from '@statamic/cms/ui';
...
const pageTitle = computed(() => Statamic.$config.get('multisiteEnabled') ? __('Configure Sites') : __('Configure Analytics'));
